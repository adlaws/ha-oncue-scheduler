...
[![HACS Validation](https://github.com/adlaws/ha-oncue/actions/workflows/hacs.yml/badge.svg)](https://github.com/adlaws/ha-oncue/actions/workflows/hacs.yml)
[![Hassfest Validation](https://github.com/adlaws/ha-oncue/actions/workflows/hassfest.yml/badge.svg)](https://github.com/adlaws/ha-oncue/actions/workflows/hassfest.yml)
[![Tests](https://github.com/adlaws/ha-oncue/actions/workflows/tests.yml/badge.svg)](https://github.com/adlaws/ha-oncue/actions/workflows/tests.yml)
...
4. Add `https://github.com/adlaws/ha-oncue` as an **Integration**
5. Search for "OnCue" and install it
6. Restart Home Assistant

### Manual

1. Download the latest release from the [releases page](https://github.com/adlaws/ha-oncue/releases)
2. Copy the `custom_components/oncue/` folder to your Home Assistant `custom_components/` directory
