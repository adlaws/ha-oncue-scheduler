...
def test_compute_slot_index_midnight():
    from oncue.coordinator import compute_slot_index
...
def test_compute_day_key_daily():
    from oncue.coordinator import compute_day_key
...
async def test_coordinator_calls_turn_on(hass):
    ...
    from oncue.coordinator import ScheduleCoordinator
    ...
    with patch("oncue.coordinator.dt_util") as mock_dt:
