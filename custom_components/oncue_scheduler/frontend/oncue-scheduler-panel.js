...
`)}_renderPaletteDeleteConfirm(t){var d;const e=L(this._palette[t]),s=e.mode==="cycle"&&e.alias?e.alias:e.color,i=this._paletteSlotCount(t),r=this._confirmDeletePaletteUsage.filter(g=>{var u;return g.id!==((u=this.schedule)==null?void 0:u.id)}),n=(d=this.schedule)==null?void 0:d.name,a=i>0;let l;if(a&&r.length>0){const g=r.map(u=>`'${u.name}'`).join(", ");l=c`This preset is in use by this schedule${n?` ('${n}')`:""} and ${g} — affected slots will be cleared.`}else if(a)l=c`This preset is used in <b>${i}</b> slot${i>1?"s":""} in this schedule — they will be cleared.`;else if(r.length>0){const g=r.map(u=>`'${u.name}'`).join(", ");l=c`This preset is in use by ${g} — affected slots will be cleared.`}else l=c`This preset is not used in any schedules.`;return c`
    ...
    `],_([v({attribute:!1})],f.prototype,"hass",2),_([v({attribute:!1})],f.prototype,"schedule",2),_([v({type:Boolean})],f.prototype,"isNew",2),_([v({attribute:!1})],f.prototype,"globalHvacPresets",2),_([v({attribute:!1})],f.prototype,"globalColorPresets",2),_([v({attribute:!1})],f.prototype,"globalBrightnessPresets",2),_([v({attribute:!1})],f.prototype,"globalScenePresets",2),_([h()],f.prototype,"_name",2),_([h()],f.prototype,"_entityIds",2),_([h()],f.prototype,"_cadence",2),_([h()],f.prototype,"_repeat",2),_([h()],f.prototype,"_startDate",2),_([h()],f.prototype,"_endDate",2),_([h()],f.prototype,"_slots",2),_([h()],f.prototype,"_conflicts",2),_([h()],f.prototype,"_saving",2),_([h()],f.prototype,"_deleting",2),_([h()],f.prototype,"_dirty",2),_([h()],f.prototype,"_confirmDelete",2),_([h()],f.prototype,"_confirmDiscard",2),_([h()],f.prototype,"_active",2),_([h()],f.prototype,"_overrides",2),_([h()],f.prototype,"_scheduledStates",2),_([h()],f.prototype,"_unavailableEntities",2),_([h()],f.prototype,"_revertDelay",2),_([h()],f.prototype,"_slotType",2),_([h()],f.prototype,"_palette",2),_([h()],f.prototype,"_hvacPresets",2),_([h()],f.prototype,"_hvacEditIndex",2),_([h()],f.prototype,"_confirmDeletePresetIndex",2),_([h()],f.prototype,"_confirmDeletePresetUsage",2),_([h()],f.prototype,"_paletteEditIndex",2),_([h()],f.prototype,"_confirmDeletePaletteIndex",2),_([h()],f.prototype,"_confirmDeletePaletteUsage",2),_([h()],f.prototype,"_pendingSlotType",2),_([h()],f.prototype,"_brightnessPresets",2),_([h()],f.prototype,"_brightnessEditIndex",2),_([h()],f.prototype,"_confirmDeleteBrightnessIndex",2),_([h()],f.prototype,"_confirmDeleteBrightnessUsage",2),_([h()],f.prototype,"_scenePresets",2),_([h()],f.prototype,"_sceneEditIndex",2),_([h()],f.prototype,"_confirmDeleteSceneIndex",2),_([h()],f.prototype,"_confirmDeleteSceneUsage",2),_([h()],f.prototype,"_isNewPreset",2),f=_([I("schedule-editor")],f);var Ot=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,$=(t,e,s,i)=>{for(var o=i>1?void 0:i?Ht(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(o=(i?n(e,s,o):n(o))||o);return i&&o&&Ot(e,s,o),o};return x.OnCuePanel=class extends w{constructor(){super(...arguments),this.narrow=!1,this._schedules=[],this._selectedSchedule=null,this._isNew=!1,this._loading=!0,this._sidebarOpen=!0,this._hvacPresets=[],this._colorPresets=[],this._brightnessPresets=[],this._scenePresets=[]}connectedCallback(){super.connectedCallback(),this._loadSchedules(),this._loadHvacPresets(),this._loadColorPresets(),this._loadBrightnessPresets(),this._loadScenePresets()}render(){var e;return this._loading?c`
        ${this._renderToolbar()}
    ...
    `}_openHassMenu(){this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))}_renderToolbar(){return this.narrow?c`
