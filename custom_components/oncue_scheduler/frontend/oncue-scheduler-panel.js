...
`;var et=Object.defineProperty,tt=Object.getOwnPropertyDescriptor,he=(s,e,t,i)=>{for(var r=i>1?void 0:i?tt(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&et(e,t,r),r};let Q=class extends A{constructor(){super(...arguments),this.schedules=[],this.selectedId=null}render(){return d`
      ...
      <div class="grid-container">
        <div class="grid-wrapper">
          ...
          <div class="mobile-grid ${this._mobilePaintMode?"paint-active":""}" @mouseup=${this._onMouseUp} @mouseleave=${this._onMouseUp}>
            ${a.map((l,n)=>{const c=n*P,f=Array.from({length:4},(u,_)=>l.startHour+_);return d`
                <div class="header-spacer"></div>
                ${f.map(u=>d`
                  <div class="header-cell" style="grid-column: span 4">${String(u).padStart(2,"0")}</div>
                `)}
                <div class="row-label ${o?"today-row":""}">${l.label}</div>
                ${Array.from({length:P},(u,_)=>{const S=c+_,M=i[S],gt=this._isInDragRegion(n,_),yt=s?this._colorCellStyle(M):"";return d`
                    <div
                      class="cell ${s?M?"color-set":"off":M?"on":"off"} ${o?"today-row":""} ${gt?"drag-preview":""} ${_%4===0?"hour-start":""}"
                      style=${yt}
                      data-row=${n}
                      data-col=${_}
                      data-day=${t}
                      title="${this._cellTooltip(S)}"
                      @mousedown=${J=>this._onMouseDown(J,n,_,t)}
                      @mouseenter=${J=>this._onMouseEnter(J,n,_)}
                      @touchstart=${J=>this._onTouchStart(J,n,_,t)}
    ...
    `}_onMobileDayChange(s){this._mobileSelectedDayKey=s.target.value}_togglePaintMode(){this._mobilePaintMode=!this._mobilePaintMode}_toggleSingleCell(s,e,t){const i=s*P+e;if(i>=w)return;const r=[...this.slots[t]??new Array(w).fill(0)];this.slotType==="color"?r[i]=r[i]===this._activePaletteIndex?0:this._activePaletteIndex:r[i]=r[i]?0:1;const o={...this.slots,[t]:r};this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:o},bubbles:!0,composed:!0}))}_weekIndex(s){if(this.cadence!=="custom")return 0;const e=new Date(s+"T00:00:00"),t=this.customDates;if(t.length===0)return 0;const i=new Date(t[0]+"T00:00:00"),r=new Date(i);r.setDate(i.getDate()-i.getDay());const o=Math.floor((e.getTime()-r.getTime())/864e5);return Math.floor(o/7)}_rowTemporalState(s){const e=new Date;if(this.cadence==="weekly"){const t=String((e.getDay()+6)%7);return s===t?"today":"other"}if(this.cadence==="custom"){const t=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`;return s===t?"today":s<t?"past":"other"}return"other"}_renderRow(s,e){const t=this.slots[s]??new Array(w).fill(0),i=this.slotType==="color",r=this.cadence==="custom"&&this._weekIndex(s)%2===1,o=this._rowTemporalState(s),a=o==="today",l=o==="past";return d`
      ...
      ${t.map((n,c)=>{const f=this._isInDragRegion(e,c),u=i?this._colorCellStyle(n):"";return d`
          <div
            class="cell ${i?n?"color-set":"off":n?"on":"off"} ${r&&!n?"week-even":""} ${a?"today-row":""} ${l?"past-row":""} ${f?"drag-preview":""} ${c%4===0?"hour-start":""}"
            style=${u}
            data-row=${e}
            data-col=${c}
            data-day=${s}
            title="${this._cellTooltip(c)}"
            @mousedown=${_=>this._onMouseDown(_,e,c,s)}
            @mouseenter=${_=>this._onMouseEnter(_,e,c)}
            @touchstart=${_=>this._onTouchStart(_,e,c,s)}
            @touchmove=${this._onTouchMove}
            @touchend=${this._onTouchEnd}
          ></div>
        `})}
    ...
    `],m([y({type:String})],v.prototype,"cadence",2),m([y({type:Object})],v.prototype,"slots",2),m([y({type:Array})],v.prototype,"customDates",2),m([y({type:String})],v.prototype,"slotType",2),m([y({type:Array})],v.prototype,"palette",2),m([h()],v.prototype,"_dragActive",2),m([h()],v.prototype,"_dragValue",2),m([h()],v.prototype,"_dragStartRow",2),m([h()],v.prototype,"_dragStartCol",2),m([h()],v.prototype,"_dragEndRow",2),m([h()],v.prototype,"_dragEndCol",2),m([h()],v.prototype,"_page",2),m([h()],v.prototype,"_activePaletteIndex",2),m([h()],v.prototype,"_nowMinutes",2),m([h()],v.prototype,"_timeIndicatorLeft",2),m([h()],v.prototype,"_mobileTimePos",2),m([h()],v.prototype,"_isMobile",2),m([h()],v.prototype,"_mobileSelectedDayKey",2),m([h()],v.prototype,"_mobilePaintMode",2),v=m([j("schedule-grid")],v);var ot=Object.defineProperty,at=Object.getOwnPropertyDescriptor,E=(s,e,t,i)=>{for(var r=i>1?void 0:i?at(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&ot(e,t,r),r};const nt=["switch","light","fan","input_boolean"],lt=["rgb","rgbw","rgbww","hs","xy"];let x=class extends A{constructor(){super(...arguments),this.slotType="on_off",this.selectedIds=[],this.overrides={},this.scheduledStates={},this.unavailableEntities=[],this.showOverrides=!1,this._query="",this._open=!1}get _availableEntities(){var t;if(!((t=this.hass)!=null&&t.states))return[];const s=new Set(this.selectedIds),e=this.slotType==="color";return Object.keys(this.hass.states).filter(i=>{var o,a;if(s.has(i))return!1;const r=i.split(".")[0];if(e){if(r!=="light")return!1;const l=(a=(o=this.hass.states[i])==null?void 0:o.attributes)==null?void 0:a.supported_color_modes;return Array.isArray(l)&&l.some(n=>lt.includes(n))}return nt.includes(r)}).map(i=>{var r,o;return{id:i,name:((o=(r=this.hass.states[i])==null?void 0:r.attributes)==null?void 0:o.friendly_name)??i}}).sort((i,r)=>i.id.localeCompare(r.id))}get _filtered(){const s=this._query.toLowerCase();return s?this._availableEntities.filter(e=>e.id.toLowerCase().includes(s)||e.name.toLowerCase().includes(s)):this._availableEntities}render(){return d`
    ...
    `}_renderEntityRow(s){var n,c,f;const e=this.overrides[s],t=this.scheduledStates[s],i=((f=(c=(n=this.hass)==null?void 0:n.states)==null?void 0:c[s])==null?void 0:f.state)==="on"?"on":"off",r=this.unavailableEntities.includes(s);let o="";r?o="unavailable":this.showOverrides&&e&&(o=e===t?"override-match":"override-conflict");const a=e==="on"?"active-on":!e&&this.showOverrides&&i==="on"?"current-state":"",l=e==="off"?"active-off":!e&&this.showOverrides&&i==="off"?"current-state":"";return d`
    ...
    `],E([y({attribute:!1})],x.prototype,"hass",2),E([y({type:String})],x.prototype,"slotType",2),E([y({type:Array})],x.prototype,"selectedIds",2),E([y({type:Object})],x.prototype,"overrides",2),E([y({type:Object})],x.prototype,"scheduledStates",2),E([y({type:Array})],x.prototype,"unavailableEntities",2),E([y({type:Boolean})],x.prototype,"showOverrides",2),E([h()],x.prototype,"_query",2),E([h()],x.prototype,"_open",2),x=E([j("entity-picker")],x);var dt=Object.defineProperty,ct=Object.getOwnPropertyDescriptor,se=(s,e,t,i)=>{for(var r=i>1?void 0:i?ct(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&dt(e,t,r),r};let L=class extends A{constructor(){super(...arguments),this.message="",this.type="info",this.visible=!1,this._timer=null}render(){return d`
  ...
  `,se([y({type:String})],L.prototype,"message",2),se([y({type:String})],L.prototype,"type",2),se([y({type:Boolean,reflect:!0})],L.prototype,"visible",2),L=se([j("toast-notification")],L);var ht=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,b=(s,e,t,i)=>{for(var r=i>1?void 0:i?pt(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&ht(e,t,r),r};const ue=96,ut=["0","1","2","3","4","5","6"];function fe(s){if(s==="daily")return{0:new Array(ue).fill(0)};if(s==="weekly"){const e={};for(const t of ut)e[t]=new Array(ue).fill(0);return e}return{}}function Me(s,e){const t=[],i=new Date(s),r=new Date(e);for(;i<=r;)t.push(i.toISOString().slice(0,10)),i.setDate(i.getDate()+1);return t}let g=class extends A{constructor(){super(...arguments),this.schedule=null,this.isNew=!1,this._name="",this._entityIds=[],this._cadence="daily",this._repeat=!0,this._startDate="",this._endDate="",this._slots={},this._conflicts=[],this._saving=!1,this._deleting=!1,this._dirty=!1,this._confirmDelete=!1,this._confirmDiscard=!1,this._active=!0,this._overrides={},this._scheduledStates={},this._unavailableEntities=[],this._revertDelay=180,this._slotType="on_off",this._palette=["#ff0000","#00ff00","#0000ff","#ffff00","#ff00ff","#00ffff","#ff8800","#ffffff"]}willUpdate(s){s.has("schedule")&&(this._loadFromSchedule(),this._confirmDelete=!1,this._confirmDiscard=!1,this._loadOverrides())}get _toast(){return this.renderRoot.querySelector("toast-notification")}_showToast(s,e="info"){var t;(t=this._toast)==null||t.show(s,e)}_loadFromSchedule(){this.schedule?(this._name=this.schedule.name,this._entityIds=[...this.schedule.entity_ids],this._cadence=this.schedule.cadence,this._repeat=this.schedule.repeat,this._startDate=this.schedule.start_date??"",this._endDate=this.schedule.end_date??"",this._slots=JSON.parse(JSON.stringify(this.schedule.slots)),this._active=this.schedule.active,this._revertDelay="revert_delay"in this.schedule?this.schedule.revert_delay:180,this._slotType=this.schedule.slot_type??"on_off",this._palette=this.schedule.palette?[...this.schedule.palette]:["#ff0000","#00ff00","#0000ff","#ffff00","#ff00ff","#00ffff","#ff8800","#ffffff"]):(this._name="",this._entityIds=[],this._cadence="daily",this._repeat=!0,this._startDate="",this._endDate="",this._slots=fe("daily"),this._active=!0,this._revertDelay=180,this._slotType="on_off",this._palette=["#ff0000","#00ff00","#0000ff","#ffff00","#ff00ff","#00ffff","#ff8800","#ffffff"]),this._dirty=!1,this._conflicts=[]}render(){if(!this.schedule&&!this.isNew)return d`<div class="empty-msg">Select a schedule or create a new one.</div>`;const s=this._cadence==="custom"&&this._startDate&&this._endDate?Me(this._startDate,this._endDate):[],e=this._saving||this._deleting;return d`
      ...
      <div class="form">
        ...
        <div class="form-group">
          ...
          <div class="cadence-row">
            <select
              id="cadence"
              .value=${this._cadence}
              @change=${t=>{const i=t.target.value;this._cadence=i,this._slots=fe(i),this._dirty=!0}}
            >
        ...
        <div class="form-group">
          ...
          <select
            ...
            @change=${t=>{const i=t.target.value;i!==this._slotType&&(this._slotType=i,this._slots=fe(this._cadence),this._cadence==="custom"&&this._rebuildCustomSlots(),this._dirty=!0)}}
          >
    ...
    `],b([y({attribute:!1})],g.prototype,"hass",2),b([y({attribute:!1})],g.prototype,"schedule",2),b([y({type:Boolean})],g.prototype,"isNew",2),b([h()],g.prototype,"_name",2),b([h()],g.prototype,"_entityIds",2),b([h()],g.prototype,"_cadence",2),b([h()],g.prototype,"_repeat",2),b([h()],g.prototype,"_startDate",2),b([h()],g.prototype,"_endDate",2),b([h()],g.prototype,"_slots",2),b([h()],g.prototype,"_conflicts",2),b([h()],g.prototype,"_saving",2),b([h()],g.prototype,"_deleting",2),b([h()],g.prototype,"_dirty",2),b([h()],g.prototype,"_confirmDelete",2),b([h()],g.prototype,"_confirmDiscard",2),b([h()],g.prototype,"_active",2),b([h()],g.prototype,"_overrides",2),b([h()],g.prototype,"_scheduledStates",2),b([h()],g.prototype,"_unavailableEntities",2),b([h()],g.prototype,"_revertDelay",2),b([h()],g.prototype,"_slotType",2),b([h()],g.prototype,"_palette",2),g=b([j("schedule-editor")],g);var ft=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,D=(s,e,t,i)=>{for(var r=i>1?void 0:i?_t(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&ft(e,t,r),r};return $.OnCuePanel=class extends A{constructor(){super(...arguments),this.narrow=!1,this._schedules=[],this._selectedSchedule=null,this._isNew=!1,this._loading=!0,this._sidebarOpen=!0}connectedCallback(){super.connectedCallback(),this._loadSchedules()}render(){var e;return this._loading?d`<div class="loading">Loading schedules...</div>`:d`
      <div class="layout">
    ...
    `],D([y({attribute:!1})],$.OnCuePanel.prototype,"hass",2),D([y({attribute:!1})],$.OnCuePanel.prototype,"panel",2),D([y({type:Boolean})],$.OnCuePanel.prototype,"narrow",2),D([h()],$.OnCuePanel.prototype,"_schedules",2),D([h()],$.OnCuePanel.prototype,"_selectedSchedule",2),D([h()],$.OnCuePanel.prototype,"_isNew",2),D([h()],$.OnCuePanel.prototype,"_loading",2),D([h()],$.OnCuePanel.prototype,"_sidebarOpen",2),$.OnCuePanel=D([j("oncue-scheduler-panel")],$.OnCuePanel),Object.defineProperty($,Symbol.toStringTag,{value:"Module"}),$}({});
