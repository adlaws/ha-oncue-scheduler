...
SLOT_TYPE_HVAC = "hvac"
SLOT_TYPE_BRIGHTNESS = "brightness"
SLOT_TYPE_SCENE = "scene"
VALID_SLOT_TYPES = {SLOT_TYPE_ON_OFF, SLOT_TYPE_COLOR, SLOT_TYPE_HVAC, SLOT_TYPE_BRIGHTNESS, SLOT_TYPE_SCENE}

MAX_PALETTE_SIZE = 10
MAX_HVAC_PRESET_COUNT = 20
MAX_BRIGHTNESS_PRESET_COUNT = 20
MAX_SCENE_PRESET_COUNT = 20
MAX_CYCLE_COLORS = 10
